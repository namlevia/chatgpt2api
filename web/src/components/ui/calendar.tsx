  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "inline-flex size-8 items-center justify-center rounded-lg hover:bg-stone-700",
        button_next: "inline-flex size-8 items-center justify-center rounded-lg hover:bg-stone-700",
        ...
        day_button: "size-9 rounded-lg text-sm transition hover:bg-stone-700",
        today: "font-semibold text-stone-950",
        selected: "[&_button]:bg-stone-800 [&_button]:text-white [&_button]:hover:bg-stone-800",
